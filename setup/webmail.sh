...
apt_install \
	dbconfig-common \
	php7.0 php7.0-sqlite3 php7.0-mcrypt php7.0-intl php7.0-json php7.0-common php-auth php-net-smtp php-net-socket php-net-sieve php-mail-mime php-crypt-gpg php7.0-gd php7.0-pspell \
